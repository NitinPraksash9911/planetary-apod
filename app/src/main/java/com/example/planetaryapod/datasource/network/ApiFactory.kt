...
import com.example.planetaryapod.BuildConfig
import com.example.planetaryapod.PlanetaryApplication
import com.example.planetaryapod.datasource.network.ApiConstant.CONNECT_TIME_OUT
import com.example.planetaryapod.datasource.network.ApiConstant.HEADER_CACHE_CONTROL
import com.example.planetaryapod.datasource.network.ApiConstant.HEADER_PRAGMA
import com.example.planetaryapod.datasource.network.ApiConstant.NETWORK_INTERCEPTOR_MAX_AGE
import com.example.planetaryapod.datasource.network.ApiConstant.READ_TIME_OUT
import com.example.planetaryapod.datasource.network.ApiConstant.WRITE_TIME_OUT
...
class ApiFactory @Inject constructor() {
    ...
    private val internetConnectionInterceptor: Interceptor
        get() = Interceptor { chain ->
            ...
            if (!PlanetaryApplication.getNetworkStatus()) {
    ...
    /**
     * [NoConnectivityException] throws when internet connectivity is very slow
     * */
    ...
    /**
     * [NoInternetException] throws when internet is not available
     * */
